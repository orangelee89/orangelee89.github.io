...
% Publication heading: title + date on first line, venue on second line right-aligned
\newcommand{\resumePubHeading}[3]{
    \item
    \begin{tabular*}{\textwidth}[t]{l@{\extracolsep{\fill}}r}
      \textbf{#1} & {\color{dark-grey}\small #3} \\
    \end{tabular*}
    \hfill {\color{dark-grey}\small\textit{#2}}
    \vspace{-4pt}
}
...
\section{PUBLICATIONS}
  \resumeSubHeadingListStart
    ...
    \resumePubHeading
      ...
      \resumeItemListStart
        \resumeItem{Licheng Luo, \textbf{Yu Xia}, Kaier Liang, Mingyu Cai}
...
\section{PROJECT EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {TeleopXR --- VR Teleoperation for Robot Manipulation over WAN}{Jan. 2026 -- Present}
      {Advisor: Prof. Hang Qiu, UCR CISL Lab \hspace{4pt}$|$\hspace{4pt} Ongoing Project}{Riverside, CA}
      \resumeItemListStart
        \resumeItem{Designed and implemented a VR-based teleoperation system for remote robot manipulation with intuitive hand-tracking control via extended reality interfaces.}
        \resumeItem{Engineered a hybrid WebRTC + Tailscale architecture to overcome ROS\,2 DDS limitations on WAN/5G networks, achieving low-latency real-time communication.}
        \resumeItem{Developed the full-stack pipeline from VR hand tracking to robot execution, including ROS\,2 integration, Docker containerization, and remote development workflows.}
      \resumeItemListEnd
      \resumeKeywords{ROS\,2, WebRTC, Tailscale, Meta Quest, Kinova Gen3, Docker, Unity, 5G}
...
%-----------SUMMARY-----------
\section{SUMMARY}
\small{Robotics M.S. from UC Riverside with publications at CoRL 2025 and IROS 2026 (under review). Hands-on experience in robot manipulation, deep reinforcement learning, teleoperation, and sim-to-real deployment across 6 physical robot platforms. Proficient in Python, C++, ROS\,2, MoveIt\,2, PyTorch, and simulation tools (Gazebo, MuJoCo, Isaac Sim). U.S. Permanent Resident.}
%-------------------------------------------
\end{document}